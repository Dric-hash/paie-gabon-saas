...
def run_migrations():
    migrations = [
        ...
        "ALTER TABLE contrats ADD COLUMN IF NOT EXISTS date_fin_essai DATE",
        ...
        "ALTER TABLE utilisateurs ADD COLUMN IF NOT EXISTS twofa_methode VARCHAR(10) DEFAULT 'email'",
        "ALTER TABLE utilisateurs ADD COLUMN IF NOT EXISTS twofa_secret VARCHAR(64)",
        "ALTER TABLE utilisateurs ADD COLUMN IF NOT EXISTS backup_codes_hash TEXT",
